                    ...
                    <div class="list-item">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="place_of_birth" value="{{ old('place_of_birth') }}" class="form-control" placeholder="Place of Birth">
                                <span style="color: red">{{ $errors->first('place_of_birth') }}</span>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">CNIC No <span style="color: red">*</span></label>
                                <input type="text" name="cnic" value="{{ old('cnic') }}" class="form-control" placeholder="CNIC No *">
                                <span style="color: red">{{ $errors->first('cnic') }}</span>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">CNIC Expire Date <span style="color: red">*</span></label>
                                <input type="date" name="cnic_expiry" value="{{ old('cnic_expiry') }}" class="form-control" placeholder="Cnic Date of Expiry *">
                            ...
                            <span id="marital-details">
                                ...
                                <div class="row">
                                    <div class="col-md-3 form-group">
                                        <input type="text" name="spouse_name" value="{{ old('spouse_name') }}" id="" class="form-control" placeholder="Spouse Name">
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <select name="spouse_gender" class="form-control" id="">
                                            <option value="male" {{ old('spouse_gender')=='male'?'selected':'' }}>Male</option>
                                            <option value="female" {{ old('spouse_gender')=='female'?'selected':'' }}>Femal</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <input type="date" name="spouse_dob" value="{{ old('spouse_dob') }}" id="" class="form-control" placeholder="Date of Birth">
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <input type="text" name="spouse_cnic_no" value="{{ old('spouse_cnic_no') }}" id="" class="form-control" placeholder="CNIC No">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group">
                                <input type="tel" name="home_ptcl_no" value="{{ old('home_ptcl_no') }}" id="" class="form-control" placeholder="HOME(PTCL) No">
                            </div>
                            <div class="col-md-4 form-group">
                                <input type="tel" name="personal_mobile_no" value="{{ old('personal_mobile_no') }}" id="" class="form-control" placeholder="Personal Mobile No *">
                                <span style="color: red">{{ $errors->first('personal_mobile_no') }}</span>
                            </div>
                            <div class="col-md-4 form-group">
                                <input type="email" name="personal_email" id="" value="{{ old('personal_email') }}" class="form-control" placeholder="Personal Email">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <input type="text" name="living_sinces[]" id="" placeholder="Living since how Long?" class="form-control">
                                        <span style="color: red">{{ $errors->first('living_sinces') }}</span>
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <input type="text" name="nearest_landmarks[]" id="" placeholder="Nearest landmark?" class="form-control">
                                        <span style="color: red">{{ $errors->first('nearest_landmarks') }}</span>
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <input type="text" name="property_types[]" id="" placeholder="Own/Rental/ Other (Pls. specify)?" class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <textarea class="form-control" name="completed_addresses[]" style="height:100px;"  placeholder="Complete Address"></textarea>
