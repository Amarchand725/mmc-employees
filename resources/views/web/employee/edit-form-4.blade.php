                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <div class="col-md-4 mb-3 mt-3">
                                    @if($model->haveEmployeeDocuments->cnic_front)
                                        <img id="cnic_front_preview" src="{{ asset('public/admin/assets/employee-docs/documents') }}/{{ $model->haveEmployeeDocuments->cnic_front }}" alt="Preview" style="height:100px; width:150px">
                                    @else
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="col-md-4 mb-3 mt-3">
                                    @if($model->haveEmployeeDocuments->cnic_back)
                                        <img id="cnic_front_preview" src="{{ asset('public/admin/assets/employee-docs/documents') }}/{{ $model->haveEmployeeDocuments->cnic_back }}" alt="Preview" style="height:100px; width:150px">
                                    @else
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="col-md-4 mb-3 mt-3">
                                    @if($model->haveEmployeeDocuments->passport)
                                        <img id="cnic_front_preview" src="{{ asset('public/admin/assets/employee-docs/documents') }}/{{ $model->haveEmployeeDocuments->passport }}" alt="Preview" style="height:100px; width:150px">
                                    @else
                            ...
                            @if(!empty($model->haveEducationDocuments))
                                <div class="form-group col-md-12">
                                    @foreach ($model->haveEducationDocuments as $edu_doc)
                                        <img id="cnic_front_preview" src="{{ asset('public/admin/assets/employee-docs/educational_documents') }}/{{ $edu_doc->document }}" alt="Preview" style="height:80px; width:100px">
                                    @endforeach
                                </div>
                            @endif
                            <div class="form-group col-md-6">
                                <label for="">Educational Documents</label>
                                <input type="file" style="margin-top: 5px" name="educational_documents[]" multiple class="form-control">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="file" style="margin-top: 5px" name="additional_documents[]" multiple class="form-control">
                                <span style="color: red">{{ $errors->first('additional_documents') }}</span>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="">NOC form previous employer(s) (Experience Certificates)</label><br />
                                @if(!empty($model->haveExperienceCertificates))
                                    <div class="form-group col-md-12">
                                        @foreach ($model->haveExperienceCertificates as $exp_certificate)
                                            <img id="cnic_front_preview" src="{{ asset('public/admin/assets/employee-docs/experience_certificates') }}/{{ $exp_certificate->document }}" alt="Preview" style="height:80px; width:100px">
                                        @endforeach
                                    </div>
                                @endif
                                <input type="file" style="margin-top: 5px" id="experience_certificates" name="experience_certificates[]" multiple class="form-control">
                                <span style="color: red">{{ $errors->first('experience_certificates') }}</span>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="">Last Three month salary slips</label><br />
                                @if(!empty($model->haveSalarySlips))
                                    <div class="form-group col-md-12">
                                        @foreach ($model->haveSalarySlips as $slip)
                                            <img id="cnic_front_preview" src="{{ asset('public/admin/assets/employee-docs/salary_slips') }}/{{ $slip->slip }}" alt="Preview" style="height:80px; width:100px">
                                        @endforeach
                                    </div>
                                @endif
                                <input type="file" style="margin-top: 5px" id="salary_slips" name="salary_slips[]" multiple class="form-control">
                                <span style="color: red">{{ $errors->first('salary_slips') }}</span>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="">An Updated Curriculum Vitae</label>
                                @if($model->haveEmployeeDocuments->updated_cv)
                                    <a href="{{ asset('public/admin/assets/employee-docs/cvs') }}/{{ $model->haveEmployeeDocuments->updated_cv }}" download><i class="fa fa-download"></i> Download Curriculum Vitae</a>
                                @endif
